      ...
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-3 rounded-lg bg-slate-50 px-4 py-3 text-sm sm:grid-cols-3">
          ...
          <div>
            ...
            <p className="font-medium text-slate-700">{plan.professional?.name ?? plan.remoteProfessionalName ?? 'Sin diagnosticador'}</p>
          </div>
          <div>
            <p className="text-xs font-semibold tracking-wide text-slate-400 uppercase">Clínica</p>
