...
export function RefreshIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6" strokeLinecap="round" strokeLinejoin="round" />
...
export function UsersIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path
        d="M3 20c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5M16 8.2a3 3 0 1 1 0 6M17.5 14.6c2.6.5 4.5 2.4 4.5 5.4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function StarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="m12 3 2.6 5.6 6 .7-4.5 4.2 1.2 6-5.3-3-5.3 3 1.2-6-4.5-4.2 6-.7L12 3Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function MicIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path d="M6 11a6 6 0 0 0 12 0M12 19v2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function CashIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path d="M6 9v0M18 15v0" strokeLinecap="round" />
    </svg>
  );
}
...
export function NewsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <rect x="3" y="4" width="14" height="16" rx="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7 8h6M7 12h6M7 16h3M17 8h4v9a3 3 0 0 1-3 3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function ToothCloudIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path
        d="M7 9.5a3.5 3.5 0 0 1 2.5-6c.86 0 1.63.35 2.19.9a3.5 3.5 0 0 1 6.11 2.79A3.5 3.5 0 0 1 17.5 14H7.8"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12 12c-1.4 0-1.4 1.6-2.8 1.6S7.8 12 6.4 12 5 13.6 5 15.4c0 2.6 1.1 5.3 1.9 5.3.8 0 .9-2.4 1.7-2.4s.9 2.4 1.7 2.4c.9 0 1.8-3.2 1.8-5.6 0 2.4.9 5.6 1.8 5.6.8 0 .9-2.4 1.7-2.4s.9 2.4 1.7 2.4c.8 0 1.9-2.7 1.9-5.3 0-1.8-1-3.4-2.4-3.4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function ChairIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M6 3v7a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V3M8 21v-4M14 21v-3"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6 12v2a2 2 0 0 0 2 2h7a3 3 0 0 1 3 3v2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function PhoneIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M4 5c0 8.3 6.7 15 15 15l2-4-5-2-1.5 2A11.2 11.2 0 0 1 8.5 9.5L10.5 8 8.5 3 4 5Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function TrashIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M4 7h16M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2m2 0-.7 12.1a2 2 0 0 1-2 1.9H8.7a2 2 0 0 1-2-1.9L6 7"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function IdBadgeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <circle cx="10" cy="10.5" r="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7 16c.5-1.8 1.8-2.5 3-2.5s2.5.7 3 2.5M14.5 9h2.5M14.5 12h2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function EditIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M16.5 4.5a2.1 2.1 0 0 1 3 3L7 20l-4 1 1-4Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function CakeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M4 21v-7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v7M4 21h16M4 17c1 1 2 1 3 0s2-1 3 0 2 1 3 0 2-1 3 0 2 1 3 0" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 12V8M9 8a3 3 0 0 1 0-4M12 8a3 3 0 0 0 0-4M15 8a3 3 0 0 0 0-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function ClipboardIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path d="M9 4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v1H9zM8 11h8M8 15h5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M8 9h8M8 12.5h5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function FolderIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M4 6a1 1 0 0 1 1-1h4l2 2h8a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function XrayIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <rect x="3" y="4" width="18" height="16" rx="2" strokeLinecap="round" strokeLinejoin="round" />
      <path
        d="M8 8v8M12 8c-1.5 1-1.5 3 0 4s1.5 3 0 4M16 8v8"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function EyeOffIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path
        d="M3 3l18 18M10.6 5.2A10.6 10.6 0 0 1 12 5c6.5 0 10 7 10 7a17.8 17.8 0 0 1-3.4 4.3M6.6 6.6C4 8.3 2 12 2 12s3.5 7 10 7a10.4 10.4 0 0 0 3.4-.6M9.5 9.5a3 3 0 0 0 4 4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
export function UploadIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M12 16V4M7 9l5-5 5 5M4 16v3a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function DownloadIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M12 4v12M7 11l5 5 5-5M4 20h16" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
